...
export default function Avataaars() {
  const [title, setTitle] = useState("");
  console.log(`https://avatars.dicebear.com/api/avataaars/${title}.svg`);
  const style = { color: "black", fontSize: "1.5em" };
  return (
    <div className="p-5">
      <Head>
        <title>Avataaars Avatar</title>
        <link
          rel="icon"
          href={`https://avatars.dicebear.com/api/avataaars/${title}.svg`}
        />
