...
export default function Miniavs() {
  const [title, setTitle] = useState("");
  console.log(`https://avatars.dicebear.com/api/miniavs/${title}.svg`);
  const style = { color: "black", fontSize: "1.5em" };
  return (
    <div className="p-5">
      <Head>
        <title>Miniavs Avatar</title>
        <link
          rel="icon"
          href={`https://avatars.dicebear.com/api/miniavs/${title}.svg`}
        />
      ...
      <div>
        ...
        <div>
          <div className="lg:w-4/5 mx-auto flex item-center justify-center">
            <img
              src={`https://avatars.dicebear.com/api/miniavs/${title}.svg`}
