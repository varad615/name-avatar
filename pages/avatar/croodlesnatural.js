...
export default function Croodlesnatural() {
  const [title, setTitle] = useState("");
  console.log(`https://avatars.dicebear.com/api/croodles-neutral/${title}.svg`);
  const style = { color: "black", fontSize: "1.5em" };
  return (
    <div className="p-5">
      <Head>
        <title>Croodles Neutral Avatar</title>
        <link
          rel="icon"
          href={`https://avatars.dicebear.com/api/croodles-neutral/${title}.svg`}
        />
